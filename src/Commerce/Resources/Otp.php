 ...
 *
 * @see https://commerce.zebo.dev/otp for OTP integration guide
 */
class Otp
{
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/otp for verification flow
     */
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/otp for session management
     */
