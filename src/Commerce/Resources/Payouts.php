 ...
 *
 * @see https://commerce.zebo.dev/payouts for detailed guides
 */
class Payouts
{
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/manage-payout-destinations for payout destination guide
     */
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/payouts for payout overview
     */
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/disable-automatic-payouts for manual payout guide
     */
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/enable-fx-payouts for FX payout guide
     */
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/payouts-fx-conversion for FX details
     */
