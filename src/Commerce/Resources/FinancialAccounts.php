...
class FinancialAccounts
{
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/set-up-financial-account for account setup guide
     */
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/financial-accounts for financial account overview
     */
    ...
    /**
     * Link a financial account to your application for payouts.
     *
     * Connects a created financial account to your Commerce application, making it available
     * as a payout destination. The account must be verified before it can receive funds.
     *
     * @param array $payload Connection parameters
     *   - account_id: string - Financial account to connect (required)
     *   - Additional connection parameters may be required depending on account type
     *
     * @return \Commerce\ResponseObject Connected financial account
     *
     * @example Connect financial account
     * ```php
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/set-up-financial-account for connection guide
     */
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/financial-accounts for account management
     */
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/financial-accounts for account overview
     ...
     * ```
     *
     * @see https://commerce.zebo.dev/set-up-financial-account for verification guide
     */
