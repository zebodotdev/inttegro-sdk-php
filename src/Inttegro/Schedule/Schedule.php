...
/**
 * A scheduled operation and its timing, creation, cancellation, and failure state.
 *
 ...
 */
final class Schedule extends \Inttegro\DomainValue
{
    /**
     * Chime Ids value for this schedule.
     *
    ...
    /**
     * Content value for this schedule.
     *
    ...
    /**
     * Customer Ids value for this schedule.
     *
    ...
    /**
     * Errors value for this schedule.
     *
     * Optional response field. PHP type: `list<\Inttegro\Schedule\Error>|null`; wire field:
     * `errors` (`array<object>`).
     * When the field is absent, the SDK exposes an empty collection.
     *
     * @var list<\Inttegro\Schedule\Error>|null
     */
    ...
    /**
     * Idempotency Key value for this schedule.
     *
    ...
    /**
     * Purpose value for this schedule.
     *
    ...
    /**
     * Recipients value for this schedule.
     *
    ...
    /**
     * Send After value for this schedule.
     *
    ...
    /**
     * Hydrates a Schedule from decoded Inttegro API data.
     *
    ...
    public function __construct(array $data)
    {
        ...
        $this->errors = \Inttegro\ValueHydrator::objects($data['errors'] ?? null, [\Inttegro\Schedule\Error::class]);
    ...
    /**
     * Creates a Schedule from its decoded API wire representation.
     *
     * @param array<string, mixed> $data Wire object keyed by `snake_case` API field names.
     * @return static A typed, immutable Schedule value.
     */
