...
/**
 * Bank Account Ghana Bank Account details associated with payment method.
 *
 ...
 */
final class BankAccountGhanaBankAccount extends \Inttegro\DomainValue
{
    /**
     * Branch value for this bank account ghana bank account.
     *
    ...
    /**
     * Account Number value for this bank account ghana bank account.
     *
    ...
    /**
     * Sort Code value for this bank account ghana bank account.
     *
    ...
    /**
     * Swift Code value for this bank account ghana bank account.
     *
    ...
    /**
     * Hydrates a BankAccountGhanaBankAccount from decoded Inttegro API data.
     *
    ...
    /**
     * Creates a BankAccountGhanaBankAccount from its decoded API wire representation.
     *
     * @param array<string, mixed> $data Wire object keyed by `snake_case` API field names.
     * @return static A typed, immutable BankAccountGhanaBankAccount value.
     */
