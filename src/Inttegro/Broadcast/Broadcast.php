...
/**
 * A multi-recipient message broadcast together with its creation, cancellation, and delivery state.
 *
 ...
 */
final class Broadcast extends \Inttegro\DomainValue
{
    /**
     * Chime Ids value for this broadcast.
     *
    ...
    /**
     * Content value for this broadcast.
     *
    ...
    /**
     * Customer Ids value for this broadcast.
     *
    ...
    /**
     * Errors value for this broadcast.
     *
    ...
    /**
     * Idempotency Key value for this broadcast.
     *
    ...
    /**
     * Purpose value for this broadcast.
     *
    ...
    /**
     * Recipients value for this broadcast.
     *
    ...
    /**
     * Send After value for this broadcast.
     *
    ...
    /**
     * Hydrates a Broadcast from decoded Inttegro API data.
     *
    ...
    /**
     * Creates a Broadcast from its decoded API wire representation.
     *
     * @param array<string, mixed> $data Wire object keyed by `snake_case` API field names.
     * @return static A typed, immutable Broadcast value.
     */
