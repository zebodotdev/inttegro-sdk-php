...
/**
 * Attribute details associated with product.
 *
 ...
 */
final class Attribute extends \Inttegro\DomainValue
{
    /**
     * Human-readable name.
     *
    ...
    /**
     * Hydrates an Attribute from decoded Inttegro API data.
     *
    ...
    /**
     * Creates an Attribute from its decoded API wire representation.
     *
     * @param array<string, mixed> $data Wire object keyed by `snake_case` API field names.
     * @return static A typed, immutable Attribute value.
     */
