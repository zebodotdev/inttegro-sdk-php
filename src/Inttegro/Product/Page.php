...
/**
 * A page of product values together with pagination metadata.
 *
...
final class Page extends \Inttegro\DomainValue
{
    ...
    /**
     * Products value for this page.
     *
     * Required response field. PHP type: `list<\Inttegro\Product\Product>`; wire field: `products`
     * (`array<object>`).
     * When the field is absent, the SDK exposes an empty collection.
     *
     * @var list<\Inttegro\Product\Product>
     */
    ...
    public function __construct(array $data)
    {
        ...
        $this->products = \Inttegro\ValueHydrator::objects($data['products'] ?? null, [\Inttegro\Product\Product::class]);
    }
