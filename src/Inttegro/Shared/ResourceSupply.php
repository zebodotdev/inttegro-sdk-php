...
/**
 * Resource Supply details associated with shared.
 *
 ...
 */
final class ResourceSupply extends \Inttegro\DomainValue
{
    /**
    ...
    /**
     * By value for this resource supply.
     *
    ...
    /**
     * Channel value for this resource supply.
     *
    ...
    /**
     * Resource Type value for this resource supply.
     *
    ...
    /**
     * Hydrates a ResourceSupply from decoded Inttegro API data.
     *
    ...
    /**
     * Creates a ResourceSupply from its decoded API wire representation.
     *
     * @param array<string, mixed> $data Wire object keyed by `snake_case` API field names.
     * @return static A typed, immutable ResourceSupply value.
     */
