...
/**
 * A page of file link values together with pagination metadata.
 *
...
final class Page extends \Inttegro\DomainValue
{
    ...
    /**
     * File Links value for this page.
     *
     * Required response field. PHP type: `list<\Inttegro\FileLink\FileLink>`; wire field:
     * `file_links` (`array<object>`).
     * When the field is absent, the SDK exposes an empty collection.
     *
     * @var list<\Inttegro\FileLink\FileLink>
     */
    ...
    public function __construct(array $data)
    {
        ...
        $this->fileLinks = \Inttegro\ValueHydrator::objects($data['file_links'] ?? null, [\Inttegro\FileLink\FileLink::class]);
    }
