...
/**
 * A page of customer values together with pagination metadata.
 *
...
{
    /**
     * Customers value for this page.
     *
     * Required response field. PHP type: `list<\Inttegro\Customer\Customer>`; wire field:
     * `customers` (`array<object>`).
     * When the field is absent, the SDK exposes an empty collection.
     *
     * @var list<\Inttegro\Customer\Customer>
     */
    ...
    {
        $this->customers = \Inttegro\ValueHydrator::objects($data['customers'] ?? null, [\Inttegro\Customer\Customer::class]);
