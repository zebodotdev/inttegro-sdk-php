...
/**
 * A page of message template values together with pagination metadata.
 *
...
final class Page extends \Inttegro\DomainValue
{
    ...
    /**
     * Message Templates value for this page.
     *
     * Required response field. PHP type: `list<\Inttegro\MessageTemplate\MessageTemplate>`; wire
     * field: `message_templates` (`array<object>`).
     * When the field is absent, the SDK exposes an empty collection.
     *
     * @var list<\Inttegro\MessageTemplate\MessageTemplate>
     */
    ...
    public function __construct(array $data)
    {
        ...
        $this->messageTemplates = \Inttegro\ValueHydrator::objects($data['message_templates'] ?? null, [\Inttegro\MessageTemplate\MessageTemplate::class]);
    }
