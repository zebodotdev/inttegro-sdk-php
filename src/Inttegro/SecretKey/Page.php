...
final class Page extends \Inttegro\DomainValue
{
    ...
    /**
     * Keys value for this page.
     *
     * Required response field. PHP type: `list<\Inttegro\SecretKey\SecretKey>`; wire field: `keys`
     * (`array<object>`).
     * When the field is absent, the SDK exposes an empty collection.
     *
     * @var list<\Inttegro\SecretKey\SecretKey>
     */
    ...
    public function __construct(array $data)
    {
        ...
        $this->keys = \Inttegro\ValueHydrator::objects($data['keys'] ?? null, [\Inttegro\SecretKey\SecretKey::class]);
    }
