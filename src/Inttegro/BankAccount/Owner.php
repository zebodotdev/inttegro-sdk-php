...
final class Owner extends \Inttegro\DomainValue
{
     ...
     *
     * Required response field. PHP type: `\Inttegro\BankAccount\OwnerAddress`; wire field:
     * `address` (`object`).
     *
     * @var \Inttegro\BankAccount\OwnerAddress
     */
    public readonly \Inttegro\BankAccount\OwnerAddress $address;
    ...
    {
        $this->address = \Inttegro\ValueHydrator::object($data['address'] ?? null, [\Inttegro\BankAccount\OwnerAddress::class], false);
