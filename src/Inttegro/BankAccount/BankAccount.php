...
/**
 * Bank-account details used by payment methods and financial accounts.
 *
...
final class BankAccount extends \Inttegro\DomainValue
{
     ...
     *
     * Optional response field. PHP type: `\Inttegro\BankAccount\Ghana|null`; wire field:
     * `ghana_bank_account` (`object`).
     *
     * @var \Inttegro\BankAccount\Ghana|null
     */
    public readonly ?\Inttegro\BankAccount\Ghana $ghanaBankAccount;
    ...
    public function __construct(array $data)
    {
        ...
        $this->ghanaBankAccount = \Inttegro\ValueHydrator::object($data['ghana_bank_account'] ?? null, [\Inttegro\BankAccount\Ghana::class], true);
    }
